...
const submitForm = async () => {
    ...
    try {
        await axios.put(`/min-ops/kasus/${props.laporan.id}`, form);
...
<template>
    ...
    <SidebarLayout :title="`Edit Laporan #${laporan?.id}`">
        ...
        <div class="max-w-4xl mx-auto">
            <!-- Back Link -->
            <div class="mb-6">
                <Link :href="`/min-ops/kasus/${laporan?.id}`" class="text-gray-500 hover:text-navy flex items-center gap-2 transition-colors">
            ...
            <form @submit.prevent="submitForm" class="bg-white rounded-xl shadow-tactical border border-tactical-border overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Nomor STPA"
                            />
                            <p v-if="errors.nomor_stpa" class="mt-1 text-sm text-red-600">{{ errors.nomor_stpa[0] }}</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Disposisi Unit</label>
                            <select
                                v-model="form.disposisi_unit"
                                class="w-full rounded-lg border-gray-300 focus:border-tactical-accent focus:ring-tactical-accent"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="w-full rounded-lg border-gray-300 focus:border-tactical-accent focus:ring-tactical-accent"
                            placeholder="Deskripsi modus operandi..."
                        ></textarea>
                    </div>
