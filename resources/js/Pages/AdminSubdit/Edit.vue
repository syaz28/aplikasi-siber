...
const props = defineProps({
    ...
    unitOptions: { type: Array, default: () => [1, 2, 3, 4, 5] },
});
...
const form = reactive({
    ...
    tanggal_laporan: props.laporan.tanggal_laporan ? props.laporan.tanggal_laporan.split('T')[0] : '',
    petugas_id: props.laporan.petugas_id || '',
    status: props.laporan.status || 'Penyelidikan',
    disposisi_unit: props.laporan.disposisi_unit || '',
...
const submitForm = async () => {
    ...
    try {
        const response = await axios.put(`/min-ops/kasus/${props.laporan.id}`, normalizedForm);
        ...
        if (response.data.success) {
            ...
            setTimeout(() => {
                router.visit(`/min-ops/kasus/${props.laporan.id}`);
            }, 2000);
        }
    } catch (err) {
...
<template>
    <Head :title="`Edit Kasus - ${laporan.nomor_stpa || 'Draft'}`" />

    <SidebarLayout title="Edit Kasus">
        <ToastContainer />
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6 bg-white rounded-xl shadow-tactical border border-tactical-border overflow-hidden">
                <div class="bg-gray-50 px-6 py-3 border-b border-gray-200">
                    <h3 class="font-semibold text-gray-700">Informasi Kasus</h3>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-tactical border border-tactical-border overflow-visible">
                ...
                <div v-if="isSuccess" class="p-12 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-navy mb-2">Kasus Berhasil Diperbarui!</h3>
                    <p class="text-gray-600 mb-8">Data kasus telah diperbarui. Anda akan dialihkan ke halaman detail.</p>
                </div>
