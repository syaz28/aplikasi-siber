                            ...
                            >
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        >
                                            ...
                                            <div class="absolute bottom-full right-0 mb-2 hidden group-hover:block z-10">
                                                <div class="bg-gray-900 text-white text-xs rounded py-1 px-2 whitespace-nowrap">
                                                    ⚠️ Terindikasi Residivis ({{ item.residivis_count }} kasus lain)
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Edit -->
                                        <Link
                                            :href="`/min-ops/kasus/${item.id}/edit`"
                                            class="p-2 text-gray-500 hover:text-tactical-accent hover:bg-blue-50 rounded-lg transition-colors"
                                            title="Edit Laporan"
                                        >
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
